...
const CardVarious = ({data}) => {
  /**
   * hacer esto mismo en los demas componentes
   * con productos  crear un efect y consultar el 
   * producto por el id del props.match
   */
  return (
